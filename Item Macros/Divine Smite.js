...
(() => {
  ...
  async function smite(actor, slotLevel, criticalHit, consume, isPact) {
      ...
      await new MidiQOL.DamageOnlyWorkflow(actor, token, damageRoll.total, "radiant", target ? [target] : [], damageRoll, {flavor: "Divine Smite - Damage Roll (Radiant)", itemCardId: args[0].itemCardId})
